...
Hello there. Internet etiquette dictates that any website that deals with stats starts with a GIF to signal that this'll be fun. I'm not one to break with etiquette, so here we go:

![](https://media.giphy.com/media/MCZ39lz83o5lC/giphy.gif)

## This website

This website collects the materials for a 2-day workshop on simulating power with R. Rather than dumping the materials in zip folder somewhere, I thought this format will be better for a) participants to revisit, b) those who might be interested in the content but couldn't make it. That's also the reason most of the materials are so annoyingly verbose: I wanted readers to be able to follow and re-visit.

[I'm](https://www.niklasjohannes.com/) giving this workshop at the University of Zurich on September 26th and 27th. If you're a workshop participant, keep reading on for details. 
...
Below is the 2-day schedule. From experience, there's quite a lot of variability on how far in the schedule we get. It'll mostly depend on how much time you need to go through the exercises (and most likely we won't do all of them). Technically, after Exercise 2, you'll have everything you need, but I aim to at least make it to interactions. The rest you can also do at home in case we don't make it all the way.
...
- For communication, please join this discord channel that we'll use throughout the 2 days: <link>

## Structure

The workshop will follow a structure of learn, do, recall. So typically, for each topic, I'll introduce theoretical concepts; then you'll do lots of exercise where you try to apply and extend these concepts; afterwards, there'll be a short quiz.
...
None of the above will work when I'm actually giving the workshop: I'll set it all to private and will reveal the solutions on the website piece by piece. I find that it helps with learning to not have the solution right away. Everything will be public--including the solutions--on the 1st of October.
